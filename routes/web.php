...
Route::middleware(['auth', 'force.password.change'])->group(function () {
    ...
    Route::middleware('can:ViewTheContionousAssessment')->group(function () {
        ...
        Route::post('/students/caResult/deleteStudentCourseAssements/{courseId}/', [ContinousAssessmentController::class, 'deleteStudentCourseAssements'])->name('docket.deleteStudentCourseAssements');
        ...
        Route::get('/students/caResult/searchForStudents/', [ContinousAssessmentController::class, 'searchForStudents'])->name('coordinator.searchForStudents');
    ...
    Route::middleware('can:Dean')->group(function () {
        // Dean specific routes can be added here
    });
    ...
    Route::middleware(['can:ViewCoordinatorsCourses'])->group(function () {
